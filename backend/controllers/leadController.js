...
exports.createLead = async (req, res) => {
  try {
    const { farmerName, farmerPhone, phone, acreage, acres, intakeChannel = 'WEBSITE', ...optional } = req.body;
    ...
    const lead = await leadRepository.create({ farmerName, farmerPhone: farmerPhone || phone || '', acreage: Number(acreage ?? acres), intakeChannel, ...optional });
